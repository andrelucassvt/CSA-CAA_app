...
import 'package:projeto_csa_app/app/modules/home/domain/errors/home_error.dart';
  ...
  Future<List<PacienteEntity>> getPacientes() async {
    try {
      ...
      if (e.type == DioErrorType.connectTimeout || e.type == DioErrorType.receiveTimeout) {
        throw HomeNoInternetConnection();
      }
      throw HomeUnkenError(message: e.message,stack: s);
    }
  }
